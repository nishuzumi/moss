...
import { fastlaneManifest } from "@themoss/protocol-fastlane";
...
export function createMossServer(opts: MossServerOptions = {}): {
  ...
  for (const manifest of [systemManifest, ercManifest, kuruManifest, fastlaneManifest]) registry.use(manifest);
