...
// The online explorer cross-check suite (pnpm test:abi:online). Kept apart from
// the offline default so a missing MONADSCAN_API_KEY fails loudly here without
// ever gating `pnpm test`.
