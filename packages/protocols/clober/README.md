...
A quote must use at least 99.9% of the requested input; this is a Moss safety policy that allows deterministic book-unit dust while rejecting materially partial fills. Swap transactions use the official SDK's [20-minute deadline window](https://github.com/clober-dex/v2-sdk/blob/affcd7661ed6df93c4a0f7617efe066fcb965959/src/utils/time.ts).
