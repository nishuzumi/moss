...
- [ ] Protocol-specific write receipts are declared with `@Event` and gated via `confirms`; canonical standard events already parsed and fully reconciled by the audit plane do not need a duplicate observation ([ADR 0008](./docs/adr/0008-observation-plane.md)).
